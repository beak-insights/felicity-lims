...
from felicity.apps.client.repositories import (ClientContactRepository,
                                               ClientRepository)
from felicity.apps.client.schemas import (ClientContactCreate,
                                          ClientContactUpdate, ClientCreate,
                                          ClientUpdate)
