...
Revision ID: 21047deac7f4
Revises: 1b3226667bb5
Create Date: 2024-01-25 09:19:36.040016
...
def upgrade():
    ...
    op.add_column(
        "laboratory", sa.Column("quality_statement", sa.String(), nullable=True)
    )
    op.add_column(
        "laboratory_setting", sa.Column("allow_billing", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "laboratory_setting",
    ...
    op.add_column(
        "laboratory_setting", sa.Column("currency", sa.String(), nullable=True)
    )
    op.add_column(
        "laboratory_setting",
