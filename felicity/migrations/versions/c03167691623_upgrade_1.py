...
def upgrade():
    ...
    op.create_index(
        op.f("ix_reflex_brain_action_uid"), "reflex_brain_action", ["uid"], unique=False
    )
    op.create_table(
        "reflex_brain_condition",
        sa.Column("reflex_brain_uid", sa.String(), nullable=False),
        sa.Column("description", sa.String(), nullable=True),
        sa.Column("priority", sa.Integer(), nullable=True),
        sa.Column("uid", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_reflex_brain_condition_uid"),
        "reflex_brain_condition",
        ["uid"],
        unique=False,
    )
    op.create_table(
        "reflex_brain_condition_criteria",
        ...
        sa.ForeignKeyConstraint(
            ["reflex_brain_condition_uid"],
            ["reflex_brain_condition.uid"],
        ),
        sa.ForeignKeyConstraint(
            ["updated_by_uid"],
            ["user.uid"],
    ...
    op.create_index(
        op.f("ix_reflex_brain_condition_criteria_uid"),
        "reflex_brain_condition_criteria",
        ["uid"],
        unique=False,
    )
    ...
    op.alter_column(
        "client_contact", "email", existing_type=sa.VARCHAR(), nullable=False
    )
    op.drop_index("ix_client_contact_email", table_name="client_contact")
    op.create_index(
        op.f("ix_client_contact_email"), "client_contact", ["email"], unique=True
    )
    ...
    op.add_column(
        "id_sequence", sa.Column("created_by_uid", sa.String(), nullable=True)
    )
    op.add_column("id_sequence", sa.Column("updated_at", sa.DateTime(), nullable=True))
    op.add_column(
        "id_sequence", sa.Column("updated_by_uid", sa.String(), nullable=True)
    )
    ...
    op.add_column(
        ...
        sa.Column("reflex_brain_action_uid", sa.String(), nullable=False),
    )
    op.add_column(
        "reflex_brain_addition", sa.Column("created_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "reflex_brain_addition", sa.Column("created_by_uid", sa.String(), nullable=True)
    )
    op.add_column(
        "reflex_brain_addition", sa.Column("updated_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "reflex_brain_addition", sa.Column("updated_by_uid", sa.String(), nullable=True)
    )
    op.drop_constraint(
        "reflex_brain_addition_reflex_brain_uid_fkey",
        "reflex_brain_addition",
        type_="foreignkey",
    )
    op.create_foreign_key(
        None, "reflex_brain_addition", "user", ["created_by_uid"], ["uid"]
    )
    op.create_foreign_key(
        None, "reflex_brain_addition", "user", ["updated_by_uid"], ["uid"]
    )
    op.create_foreign_key(
        None,
        "reflex_brain_addition",
        "reflex_brain_action",
        ["reflex_brain_action_uid"],
        ["uid"],
    )
    ...
    op.add_column(
        "reflex_brain_final", sa.Column("created_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "reflex_brain_final", sa.Column("created_by_uid", sa.String(), nullable=True)
    )
    op.add_column(
        "reflex_brain_final", sa.Column("updated_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "reflex_brain_final", sa.Column("updated_by_uid", sa.String(), nullable=True)
    )
    op.drop_constraint(
        "reflex_brain_final_reflex_brain_uid_fkey",
        "reflex_brain_final",
        type_="foreignkey",
    )
    op.create_foreign_key(
    ...
    op.create_foreign_key(
        None, "reflex_brain_final", "user", ["updated_by_uid"], ["uid"]
    )
    op.create_foreign_key(
        None, "reflex_brain_final", "user", ["created_by_uid"], ["uid"]
    )
    ...
    op.add_column(
        "shipped_sample", sa.Column("created_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "shipped_sample", sa.Column("created_by_uid", sa.String(), nullable=True)
    )
    op.add_column(
        "shipped_sample", sa.Column("updated_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "shipped_sample", sa.Column("updated_by_uid", sa.String(), nullable=True)
    )
    ...
    op.add_column(
        "user_preference", sa.Column("created_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "user_preference", sa.Column("created_by_uid", sa.String(), nullable=True)
    )
    op.add_column(
        "user_preference", sa.Column("updated_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "user_preference", sa.Column("updated_by_uid", sa.String(), nullable=True)
    )
...
def downgrade():
    ...
    op.add_column(
        "report_impress",
        sa.Column(
            "date_generated", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
    )
    ...
    op.add_column(
        "reflex_brain_final",
        sa.Column(
            "reflex_brain_uid", sa.VARCHAR(), autoincrement=False, nullable=False
        ),
    )
    ...
    op.create_index(
        "ix_client_contact_email", "client_contact", ["email"], unique=False
    )
    op.alter_column(
        "client_contact", "email", existing_type=sa.VARCHAR(), nullable=True
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["analysis_uid"],
            ["analysis.uid"],
            name="reflex_brain_criteria_analysis_uid_fkey",
        ),
        sa.ForeignKeyConstraint(
            ["reflex_brain_uid"],
            ["reflex_brain.uid"],
            name="reflex_brain_criteria_reflex_brain_uid_fkey",
        ),
        sa.PrimaryKeyConstraint(
            "analysis_uid", "reflex_brain_uid", "uid", name="reflex_brain_criteria_pkey"
        ),
    )
    op.create_index(
        "ix_reflex_brain_criteria_uid", "reflex_brain_criteria", ["uid"], unique=False
    )
    op.drop_index(
        op.f("ix_reflex_brain_condition_criteria_uid"),
        table_name="reflex_brain_condition_criteria",
    )
    op.drop_table("reflex_brain_condition_criteria")
    op.drop_index(
        op.f("ix_reflex_brain_condition_uid"), table_name="reflex_brain_condition"
    )
