...
def upgrade():
    ...
    op.create_index(
        op.f("ix_user_auth_user_name"), "user_auth", ["user_name"], unique=True
    )
    op.create_table(
        "user_preference",
    ...
    op.create_index(
        op.f("ix_stock_packaging_uid"), "stock_packaging", ["uid"], unique=False
    )
    op.create_table(
        "stock_unit",
        sa.Column("name", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_stock_product_uid"), "stock_product", ["uid"], unique=False
    )
    op.create_table(
        "storage_section",
        sa.Column("name", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_stock_transaction_uid"), "stock_transaction", ["uid"], unique=False
    )
    op.create_table(
        "storage_container",
        sa.Column("name", sa.String(), nullable=False),
