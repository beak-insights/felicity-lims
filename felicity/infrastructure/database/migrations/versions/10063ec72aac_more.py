...
Revision ID: 10063ec72aac
Revises: 62c9ae0d42b7
Create Date: 2023-09-02 22:32:50.834432
...
def upgrade():
    ...
    op.create_index(op.f('ix_error_log_uid'), 'error_log', ['uid'], unique=False)
    ...
    op.create_table('sample_type_coding',
    ...
    op.create_index(op.f('ix_sample_type_coding_uid'), 'sample_type_coding', ['uid'], unique=False)
    ...
    op.create_index(op.f('ix_result_option_uid'), 'result_option', ['uid'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_result_option_uid'), table_name='result_option')
    op.drop_table('result_option')
    ...
    op.drop_index(op.f('ix_sample_type_coding_uid'), table_name='sample_type_coding')
    op.drop_table('sample_type_coding')
    ...
    op.drop_index(op.f('ix_error_log_uid'), table_name='error_log')
