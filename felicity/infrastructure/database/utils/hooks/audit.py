...
from infrastructure.database.utils.hooks.conf import hooks
...
class AuditHook:
    ...
    def audit_insert(mapper, connection, target):
        ...
        target.create_audit(
            connection, target.__tablename__, target.uid, hooks.events.CREATE
        )
    ...
    def audit_delete(mapper, connection, target):
        ...
        target.create_audit(
            connection, target.__tablename__, target.uid, hooks.events.DELETE
        )
