import{P as g,a9 as x,Z as d,aa as h,h as w,o as i,c as r,b as s,E as _,F as u,D as k,_ as D}from"./index-d30fd8e2.js";import{u as S}from"./samples-236cef2a.js";import"./analyses.mutations-ddd21bab.js";import"./storage.mutations-550380c2.js";const Z={class:"mx-auto w-fit"},C={class:"flex justify-start items-center gap-x-1"},B={class:"mr-2"},O={id:"printZoneOuter"},U={id:"printZone",class:"mx-auto w-fit overflow-y-scroll overscroll-contain max-h-[750px]"},$=["src"],A="40mm 30mm",E=g({__name:"index",setup(M){const m=x();let n=[];if(window.history.state.sampleUids)n=JSON.parse(window.history.state.sampleUids??"");else{const t=JSON.parse(m.query.sampleUids?.toString()??"");n=Array.isArray(t)?t:t?.split(",")}const o=d(2),a=(t=!0)=>{if(t)o.value++;else{if(o.value===1)return;o.value--}},l=d([]);h(async()=>{l.value=await y(n)});const c=w(()=>l.value.flatMap(t=>Array(o.value).fill(t))),{barcodeSamples:y}=S(),b=t=>`data:application/png;base64,${t}`,f=()=>{const t=document.getElementById("printZoneOuter").innerHTML,e=window.open("","_blank");e&&(e.document.open(),e.document.write(`
          <html>
            <head>
