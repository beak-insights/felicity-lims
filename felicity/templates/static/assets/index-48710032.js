import{d as _,J as h,r as p,q as g,p as x,o as i,c as r,b as s,t as w,F as c,C as k,k as C}from"./index-d5ae4e74.js";import{u as D}from"./samples-23661636.js";import"./analyses.mutations-f20367a3.js";import"./storage.mutations-7d6ed6e6.js";const S={class:"mx-auto w-fit"},Z={class:"flex justify-start items-center gap-x-1"},B={class:"mr-2"},O=s("span",null,"Print",-1),U=[O],$=s("hr",{class:"my-4"},null,-1),A={id:"printZoneOuter"},J={id:"printZone",class:"mx-auto w-fit overflow-y-scroll overscroll-contain max-h-[750px]"},M=["src"],N="40mm 30mm",q=_({__name:"index",setup(E){const u=h();let n=[];if(window.history.state.sampleUids)n=JSON.parse(window.history.state.sampleUids??"");else{const t=JSON.parse(u.query.sampleUids?.toString()??"");n=Array.isArray(t)?t:t?.split(",")}const o=p(2),a=(t=!0)=>{if(t)o.value++;else{if(o.value===1)return;o.value--}},l=p([]);g(async()=>{l.value=await y(n)});const m=x(()=>l.value.flatMap(t=>Array(o.value).fill(t))),{barcodeSamples:y}=D(),b=t=>`data:application/png;base64,${t}`,f=()=>{const t=document.getElementById("printZoneOuter").innerHTML,e=window.open("","_blank");e&&(e.document.open(),e.document.write(`
          <html>
            <head>
