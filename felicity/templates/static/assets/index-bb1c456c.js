import{d as _,N as h,r as c,y as g,x,o as i,c as r,b as s,t as w,F as p,E as k,k as D}from"./index-6a324368.js";import{u as S}from"./samples-e00dd436.js";const C={class:"mx-auto w-fit"},Z={class:"flex justify-start items-center gap-x-1"},B={class:"mr-2"},N=s("span",null,"Print",-1),O=[N],U=s("hr",{class:"my-4"},null,-1),$={id:"printZoneOuter"},A={id:"printZone",class:"mx-auto w-fit overflow-y-scroll overscroll-contain max-h-[750px]"},E=["src"],M="40mm 30mm",F=_({__name:"index",setup(J){const u=h();let n=[];if(window.history.state.sampleUids)n=JSON.parse(window.history.state.sampleUids??"");else{const t=JSON.parse(u.query.sampleUids?.toString()??"");n=Array.isArray(t)?t:t?.split(",")}const o=c(2),a=(t=!0)=>{if(t)o.value++;else{if(o.value===1)return;o.value--}},l=c([]);g(async()=>{console.log(n),l.value=await y(n)});const m=x(()=>l.value.flatMap(t=>Array(o.value).fill(t))),{barcodeSamples:y}=S(),b=t=>`data:application/png;base64,${t}`,f=()=>{const t=document.getElementById("printZoneOuter").innerHTML,e=window.open("","_blank");e&&(e.document.open(),e.document.write(`
          <html>
            <head>
