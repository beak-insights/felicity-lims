import{d as _,P as h,r as c,N as g,D as x,o as i,c as r,b as s,t as w,F as p,p as k,k as D}from"./index-73e47413.js";import{u as S}from"./samples-91ba4dc5.js";const C={class:"mx-auto w-fit"},Z={class:"flex justify-start items-center gap-x-1"},B={class:"mr-2"},N=s("span",null,"Print",-1),O=[N],U=s("hr",{class:"my-4"},null,-1),$={id:"printZoneOuter"},A={id:"printZone",class:"mx-auto w-fit overflow-y-scroll overscroll-contain max-h-[750px]"},M=["src"],P="40mm 30mm",E=_({__name:"index",setup(F){const u=h();let n=[];if(window.history.state.sampleUids)n=JSON.parse(window.history.state.sampleUids??"");else{const t=JSON.parse(u.query.sampleUids?.toString()??"");n=Array.isArray(t)?t:t?.split(",")}const o=c(2),a=(t=!0)=>{if(t)o.value++;else{if(o.value===1)return;o.value--}},l=c([]);g(async()=>{console.log(n),l.value=await y(n)});const m=x(()=>l.value.flatMap(t=>Array(o.value).fill(t))),{barcodeSamples:y}=S(),b=t=>`data:application/png;base64,${t}`,f=()=>{const t=document.getElementById("printZoneOuter").innerHTML,e=window.open("","_blank");e&&(e.document.open(),e.document.write(`
          <html>
            <head>
