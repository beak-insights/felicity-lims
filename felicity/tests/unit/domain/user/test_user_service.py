...
from domain.exceptions import (
    NotAllowedError, AleadyExistsError, ValidationError
)
...
class UserServiceTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_add_user(self):
        ...
        self.repository.create.return_value = mock.AsyncMock(return_value=User(**{"uid": uid, **self.user_data}))
    ...
    async def test_add_user_email_already_exists(self):
        ...
        with self.assertRaises(AleadyExistsError):
