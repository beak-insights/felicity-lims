...
from felicity.apps.analysis.models.qc import QCSet, QCLevel, QCTemplate
...
# Graphene QCSet Type
class QCSetType(SQLAlchemyObjectType):
    class Meta:
        model = QCSet
        interfaces = (relay.Node, )


# Graphene QCLevel Type
class QCLevelType(SQLAlchemyObjectType):
    class Meta:
        model = QCLevel
        interfaces = (relay.Node, )
