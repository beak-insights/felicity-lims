...
AnalysisProfileResponse = strawberry.union("AnalysisProfileResponse", (a_types.ProfileType, OperationError),  # noqa
...
@strawberry.mutation
async def update_profile(info, uid: int, payload: ProfileInputType) -> AnalysisProfileResponse:
