...
from .quality_control import (
    create_QC_set, create_QC_level, update_QC_level,
    create_QC_template, update_QC_template
)
...
AnalysisMutations = create_type(
    "Mutation",
    [
        create_sample_type, update_sample_type,
        create_result_option, update_result_option,
        create_rejection_reason, update_rejection_reason,
        ...
        submit_analysis_results, verify_analysis_results, retract_analysis_results, retest_analysis_results,
        cancel_analysis_results, re_instate_analysis_results,
        create_QC_set, create_QC_level, update_QC_level, create_QC_template, update_QC_template
    ]
)
