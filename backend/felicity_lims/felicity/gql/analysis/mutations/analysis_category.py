...
AnalysisCategoryResponse = strawberry.union("AnalysisCategoryResponse", (a_types.AnalysisCategoryType, OperationError),  # noqa
...
@strawberry.mutation
async def create_analysis_category(info, payload: AnalysisCategoryInputType) -> AnalysisCategoryResponse:
...
@strawberry.mutation
async def update_analysis_category(self, info, uid: int, payload: AnalysisCategoryInputType) -> AnalysisCategoryResponse:  # noqa
