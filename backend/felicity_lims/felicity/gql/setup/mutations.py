...
LaboratoryResponse = strawberry.union("PatientResponse",
                                      (LaboratoryType, OperationError),  # noqa
                                      description=""
                                      )

InstrumentResponse = strawberry.union("InstrumentResponse",
                                      (InstrumentType, OperationError),  # noqa
                                      description=""
                                      )
MethodResponse = strawberry.union("MethodResponse",
                                  (MethodType, OperationError),  # noqa
                                  description=""
                                  )
CountryResponse = strawberry.union("CountryResponse",
                                   (CountryType, OperationError),  # noqa
                                   description=""
                                   )
ProvinceResponse = strawberry.union("ProvinceResponse",
                                    (ProvinceType, OperationError),  # noqa
                                    description=""
                                    )
DistrictResponse = strawberry.union("DistrictResponse",
                                    (DistrictType, OperationError),  # noqa
                                    description=""
                                    )
SupplierResponse = strawberry.union("SupplierResponse",
                                    (SupplierType, OperationError),  # noqa
                                    description=""
                                    )
DepartmentResponse = strawberry.union("DepartmentResponse",
                                      (DepartmentType, OperationError),  # noqa
                                      description=""
...
class SetupMutations:
    @strawberry.mutation
    async def create_laboratory(self, info, payload: LaboratoryInputType) -> LaboratoryResponse:  # noqa

        if not payload.lab_name:
            return OperationError(
                error="Please Provide a name for your laboratory"
            )
    ...
    @strawberry.mutation
    async def update_laboratory(self, info, uid: int, payload: LaboratoryInputType) -> LaboratoryResponse:  # noqa

        if not uid:
            return OperationError(
                error="No uid provided to identity update obj"
            )
    ...
    @strawberry.mutation
    async def create_department(root, info, payload: DepartmentInputType) -> DepartmentResponse:  # noqa

        if not payload.name:
            return OperationError(
                error="Please Provide a name for your department"
            )
    ...
    @strawberry.mutation
    async def update_department(self, info, uid: int, payload: DepartmentInputType) -> DepartmentResponse:  # noqa
    ...
    @strawberry.mutation
    async def create_supplier(self, info, payload: SupplierInputType) -> SupplierResponse:  # noqa

        if not payload.name:
            return OperationError(
                error="Please Provide a name for your supplier"
            )
    ...
    @strawberry.mutation
    async def update_supplier(self, info, uid: int, payload: SupplierInputType) -> SupplierResponse:  # noqa
    ...
    @strawberry.mutation
    async def create_instrument(self, info, payload: InstrumentInputType) -> InstrumentResponse:  # noqa
    ...
    @strawberry.mutation
    async def update_instrument(self, info, uid: int, payload: InstrumentInputType) -> InstrumentResponse:  # noqa
    ...
    async def create_method(self, info, payload: MethodInputType) -> MethodResponse:  # noqa
        ...
        if not payload.name:
            return OperationError(
                error="Provide a name for your method"
            )
        ...
        if exists:
            return OperationError(
                error=f"A Method named {payload.name} already exists"
            )
    ...
    @strawberry.mutation
    async def update_method(self, info, uid: int, payload: MethodInputType) -> MethodResponse:  # noqa
    ...
    async def create_country(self, info, payload: CountryInputType) -> CountryResponse:  # noqa
        ...
        if not payload.name:
            return OperationError(
                error="Please Provide a name for the country"
            )
    ...
    @strawberry.mutation
    async def update_country(self, info, uid: int, payload: CountryInputType) -> CountryResponse:  # noqa
    ...
    @strawberry.mutation
    async def create_province(self, info, payload: ProvinceInputType) -> ProvinceResponse:  # noqa
        if not payload.name:
            return OperationError(
                error="Please Provide a name for the Province"
            )
    ...
    @strawberry.mutation
    async def update_province(self, info, uid: int, payload: ProvinceInputType) -> ProvinceResponse:  # noqa
    ...
    @strawberry.mutation
    async def create_district(self, info, payload: DistrictInputType) -> DepartmentResponse:  # noqa

        if not payload.name:
            return OperationError(
                error="Please Provide a name for the district"
            )
    ...
    @strawberry.mutation
    async def update_district(self, info, uid: int, payload: DistrictInputType) -> DistrictResponse:  # noqa
        if not uid:
            return OperationError(
                error="No uid provided to identity update obj"
            )
