...
class NotificationQuery:
    @strawberry.field
    async def notification_filter(self, info, group_uid: Optional[int], department_uid: Optional[int],
                                  user_uid: Optional[int]) -> List[NotificationType]:
        filters = {}
        ...
        notifications = (await models.Notification.session.execute(notif_stmt)).scalars().all()
