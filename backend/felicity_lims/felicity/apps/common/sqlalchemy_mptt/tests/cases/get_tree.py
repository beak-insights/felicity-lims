        ...
        reference_tree = [
            {
                "node": go(1),
                "children": [
                    {"node": go(2), "children": [{"node": go(3)}]},
                    {"node": go(4), "children": [{"node": go(5)}, {"node": go(6)}]},
                    {
                        "node": go(7),
                        "children": [
            ...
            },
            {
                "node": go(12),
                "children": [
                    {"node": go(13), "children": [{"node": go(14)}]},
                    {"node": go(15), "children": [{"node": go(16)}, {"node": go(17)}]},
                    {
                        "node": go(18),
                        "children": [
                            {"node": go(19), "children": [{"node": go(20)}]},
                            {"node": go(21), "children": [{"node": go(22)}]},
                        ],
                    },
                ],
            },
            ...
            },
            {
                "children": [
                    ...
                    },
                    {
                        "children": [
                            {
                                "children": [{"id": 20, "label": "<Node (20)>"}],
                                "id": 19,
                                "label": "<Node (19)>",
                            },
                            {
                                "children": [{"id": 22, "label": "<Node (22)>"}],
                                "id": 21,
                                "label": "<Node (21)>",
                            },
                        ],
        ...
        reference_tree = [
            {
                ...
                "children": [
                    {
                        "visible": True,
                        "children": [{"visible": True, "id": 3, "label": "<Node (3)>"}],
                        "id": 2,
                        "label": "<Node (2)>",
                    },
                    {
