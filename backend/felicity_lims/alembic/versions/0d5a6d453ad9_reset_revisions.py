...
Revision ID: 0d5a6d453ad9
Revises: 
Create Date: 2021-05-10 18:28:14.399540
...
def upgrade():
    ...
    sa.Column('create_by_uid', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['create_by_uid'], ['user.uid'], ),
    ...
    sa.Column('commenter_uid', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['commenter_uid'], ['user.uid'], ),
    ...
    sa.ForeignKeyConstraint(['task_uid'], ['listingtask.uid'], ),
    sa.ForeignKeyConstraint(['user_uid'], ['user.uid'], ),
    sa.PrimaryKeyConstraint('uid', 'task_uid', 'user_uid')
    )
    op.create_index(op.f('ix_taskmember_uid'), 'taskmember', ['uid'], unique=False)
    ...
    sa.ForeignKeyConstraint(['task_uid'], ['listingtask.uid'], ),
    sa.PrimaryKeyConstraint('uid', 'task_uid', 'tag_uid')
    )
    op.create_index(op.f('ix_tasktagged_uid'), 'tasktagged', ['uid'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_tasktagged_uid'), table_name='tasktagged')
    op.drop_table('tasktagged')
    op.drop_index(op.f('ix_taskmilestone_uid'), table_name='taskmilestone')
    op.drop_table('taskmilestone')
    op.drop_index(op.f('ix_taskmember_uid'), table_name='taskmember')
