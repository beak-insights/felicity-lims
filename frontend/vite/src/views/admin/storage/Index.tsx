...
import { ADD_STORE_ROOM, EDIT_STORE_ROOM,
  ADD_STORAGE_LOCATION, EDIT_STORAGE_LOCATION,
  ADD_STORAGE_SECTION, EDIT_STORAGE_SECTION,
  ADD_STORAGE_CONTAINER, EDIT_STORAGE_CONTAINER  } from '../../../graphql/storage.mutations';
...
const StorageHome = defineComponent({
  name: 'storage-home',
  setup(props, ctx) {
    const { treeData, tags, activeTree, newStoreRoom, newStorageLocation, newStorageSection, newStorageContainer } = useTreeStateComposable()   
    ...
    function addStoreRoom(): void {
      ...
      withClientMutation(ADD_STORE_ROOM, { payload }, "createStoreRoom")
      .then((result) => {
    ...
    function editStoreRoom(): void {
      ...
      withClientMutation(EDIT_STORE_ROOM, { uid: state.roomForm.uid, payload }, "updateStoreRoom")
    ...
    function addStorageLocation(): void {
      ...
      withClientMutation(ADD_STORAGE_LOCATION, { payload }, "createStorageLocation")
      .then((result) => {
    ...
    function editStorageLocation(): void {
      ...
      withClientMutation(EDIT_STORAGE_LOCATION, { uid: state.locationForm.uid, payload }, "updateStorageLocation")
    ...
    function addStorageSection(): void {
      ...
      withClientMutation(ADD_STORAGE_SECTION, { payload }, "createStorageSection")
      .then((result) => {
    ...
    function editStorageSection(): void {
      ...
      withClientMutation(EDIT_STORAGE_SECTION, { uid: state.sectionForm.uid, payload }, "updateStorageSection")
    ...
    function addStorageContainer(): void {
      ...
      withClientMutation(ADD_STORAGE_CONTAINER, { payload }, "createStorageContainer")
      .then((result) => {
    ...
    function editStorageContainer(): void {
      ...
      withClientMutation(EDIT_STORAGE_CONTAINER, { uid: state.containerForm.uid, payload }, "updateStorageContainer")
    ...
    return { 
      ...
      saveStorageContainerForm, containerFormManager ,
      calculateRows, changeContainerType
    }
  },
  render() {
    return (
      <>
        <div class="grid grid-cols-12 gap-4 min-h-full bg-white">
          <div className="col-span-2 pt-4 pl-2">
            <button onClick={() => this.roomFormManager(true, null)}
                class="px-2 py-1 border-sky-800 border text-sky-800rounded-smtransition duration-300 hover:bg-sky-800 hover:text-white focus:outline-none">Add Store Room</button>
            <hr class="mt-2 mb-4" />
            <ul>
          ...
          <div className="col-span-6 pt-4">
            ...
            <div class="my-4">
              {this.nextTreeType === this.tags.storageLocation ? (<>
                <button onClick={() => this.locationFormManager(true, null)}
              ...
              {this.nextTreeType === this.tags.storageSection ? (<>
                <button onClick={() => this.sectionFormManager(true, null)}
        ...
        (<Modal onClose={() => this.roomModalShow = false} contentWidth="w-1/4">
          {{
            ...
            body: () => {
              return <form action="post" class="p-1">
