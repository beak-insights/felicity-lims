...
import accordion from '../../../_components/accordion/Accordion.vue';
...
export default defineComponent({
  ...
  setup() {
    ...
    function updateGroupPerms(group, permission): void {
    ...
    function belongsToGroup(group, permission): boolean {
