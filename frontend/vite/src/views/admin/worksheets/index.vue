<script setup lang="ts">
  ...
  import { useWorksheetStore, useAnalysisStore, useSampleStore, useSetupStore } from '../../../stores';
  ...
  const workSheetTemplates = computed<IWorkSheetTemplate[]>(() => worksheetStore.getWorkSheetTemplates);
  ...
  function addWorksheetTemplate() {
    ...
    withClientMutation(ADD_WORKSHEET_TEMPLATE,{ payload }, "createWorksheetTemplate")
  ...
  function editWorksheetTemplate() {
    ...
    withClientMutation(EDIT_WORKSHEET_TEMPLATE, { uid: workSheetTemplate.uid, payload }, "updateWorksheetTemplate")
