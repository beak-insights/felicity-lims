  ...
  <div class="mx-auto flex flex-col items-center h-full">
    <div class="flex-none relative">
      ...
      <nav id="aside-nav" class="" role="navigation">
        ...
        <router-link to="/quality-control" id="markdown-link" class="flex items-center has-tooltip mt-1 py-2 px-6 text-gray-500 hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-100 border-l-4 border-gray-700">
