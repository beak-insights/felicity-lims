<template>
    ...
    <div ref="checdiv" class="w-full h-screen bg-gray-800 bg-opacity-90 top-0 overflow-y-auto hidden overflow-x-hidden fixed sticky-0 z-10 ">
      <div ref="notification" class=" w-full absolute z-20 right-0 h-full overflow-x-hidden transform translate-x-full transition ease-in-out duration-700 ">
