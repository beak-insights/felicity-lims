        ...
        >
          <div class="flex-grow p-1">
            <div class="font-semibold text-gray-700 flex justify-between">
              ...
              <span class="text-sm text-gray-500">{{ pt.age }} yrs, {{ pt.gender }}</span>
            </div>
              ...
              <div class="grid grid-cols-2 mt-2">
                <div class="col-span-1">
                  ...
                  <div class="flex">
                    ...
                    <span class="text-gray-600 text-sm md:text-md">{{ patient.clientName }}</span>
                  </div>
                  <div class="flex">
                    <span class="text-gray-800 text-sm font-medium w-16">District:</span>
                    <span class="text-gray-600 text-sm md:text-md">{{ patient.districtName }}</span>
                  </div>
                  <div class="flex">
                    <span class="text-gray-800 text-sm font-medium w-16">Province:</span>
                    <span class="text-gray-600 text-sm md:text-md">{{ patient.provinceName }}</span>
                  </div>
                </div>
                <div class="col-span-1">
                  <!-- Identifiers -->
