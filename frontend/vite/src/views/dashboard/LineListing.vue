    ...
    <template v-slot:body>
      <div class="overflow-x-auto mt-4" >
          ...
          class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-2 pt-1 rounded-bl-sm rounded-br-sm">
            <table class="min-w-full">
                ...
                <tr>
                    ...
                    <th class="px-1 py-1 border-b-2 border-gray-300 text-left leading-4 text-gray-800 tracking-wider">Report Type</th>
                    <th class="px-1 py-1 border-b-2 border-gray-300 text-left text-sm leading-4 text-gray-800 tracking-wider">Generated By</th>
                    <th class="px-1 py-1 border-b-2 border-gray-300 text-left text-sm leading-4 text-gray-800 tracking-wider">Date Generated</th>
                    <th class="px-1 py-1 border-b-2 border-gray-300 text-left text-sm leading-4 text-gray-800 tracking-wider">Period Start</th>
                    <th class="px-1 py-1 border-b-2 border-gray-300 text-left text-sm leading-4 text-gray-800 tracking-wider">Period End</th>
                ...
                <tbody class="bg-white">
                  <tr v-for="report in state.reports"  :key="report.uid">
                      ...
                      <td class="px-1 py-1 whitespace-no-wrap border-b border-gray-500">
                        <div class="text-sm leading-5 text-sky-800">{{ report.report_type }}</div>
                      </td>
                      <td class="px-1 py-1 whitespace-no-wrap border-b border-gray-500">
                        <div class="text-sm leading-5 text-sky-800">{{ report?.created_by?.first_name }} {{ report?.created_by?.last_name }}</div>
                      </td>
                      <td class="px-1 py-1 whitespace-no-wrap border-b border-gray-500">
                        <div class="text-sm leading-5 text-sky-800">{{ report?.created_at }}</div>
                      </td>
                      <td class="px-1 py-1 whitespace-no-wrap border-b border-gray-500">
                        <div class="text-sm leading-5 text-sky-800">{{ report?.period_start }}</div>
                      </td>
                      <td class="px-1 py-1 whitespace-no-wrap border-b border-gray-500">
                        <div class="text-sm leading-5 text-sky-800">{{ report?.period_end }}</div>
                      </td>
                      <td class="px-1 py-1 whitespace-no-wrap border-b border-gray-500">
                        <div class="text-sm leading-5 text-sky-800">{{ report?.status }}</div>
                      </td>
                      <td class="px-1 py-1 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
                          <button v-show="report.status == 'READY'"
                          ...
                          class="px-2 py-1 mr-2 border-orange-600 border text-orange-600rounded-smtransition duration-300 hover:bg-orange-600 hover:text-white focus:outline-none">Delete</button>
                      </td>
                  </tr>
                </tbody>
            </table>
          ...
          <div v-else class="py-4 pl-4 bg-white ">
            ...
            <hr>
            <p class="italic">Once a download request has been done. Your reports will be appear here</p>
          </div>
      </div>
    </template>
  </accordion>
