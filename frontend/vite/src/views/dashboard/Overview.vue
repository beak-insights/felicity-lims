...
<template>
  ...
  <div class="flex justify-start">
    <div v-for="analyte in state.overViewStats?.analyses" :key="analyte.group"
  ...
  <hr class="my-2">
  <div class="flex justify-start">
    <div v-for="sample in state.overViewStats?.samples" :key="sample.group"
    class="flex items-center bg-white shadow rounded-sm px-6 pt-3 pb-5 border border-white mr-8">
  ...
  <hr class="my-2">
  <div class="flex justify-start">
    <div v-for="worksheet in state.overViewStats?.worksheets" :key="worksheet.group"
    class="flex items-center bg-white shadow rounded-sm px-6 pt-3 pb-5 border border-white mr-8">
