...
import { GetLaboratoryQuery, GetLaboratoryQueryVariables,GetLaboratoryDocument,
    EditLaboratoryMutation, EditLaboratoryMutationVariables, EditLaboratoryDocument, 
    useEditLaboratoryMutation
...
const laboratory = await withClientQuery<GetLaboratoryQuery, GetLaboratoryQueryVariables>(
...
<EditLaboratoryMutation, EditLaboratoryMutationVariables>(
EditLaboratoryDocument,
{uid: "", payload: { labName: "" }},
'updateLaboratory'
);


const dept = await useEditLaboratoryMutation()
.executeMutation(
    {uid: "", payload: { labName: "" }},
