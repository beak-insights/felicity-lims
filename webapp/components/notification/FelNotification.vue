...
<template>
  <div ref="checdiv"
    class="w-full h-screen bg-secondary bg-opacity-90 top-0 overflow-y-auto hidden overflow-x-hidden fixed sticky-0 z-10">
    <div ref="notification"
      ...
      <div class="2xl:w-4/12 bg-background h-screen overflow-y-auto p-8 absolute right-0">
        ...
        <div v-for="stream of streamStore.streams" :key="stream?.uid"
          ...
          <div tabindex="0" aria-label="heart icon" role="img"
            class="focus:outline-none w-6 h-6 border rounded-full border-border flex items-center justify-center">
