...
<template>
  ...
  >
    ...
    >
      <div class="2xl:w-4/12 bg-gray-50 h-screen overflow-y-auto p-8 absolute right-0 flex flex-col">
        ...
        <div
          class="w-full my-4 py-1 px-2 bg-white shadow-xs flex-1"
        >
          <slot name="body">Drawer Body</slot>
        </div>

        <div
          class="w-full my-1 py-1 px-2 flex items-center"
        >
