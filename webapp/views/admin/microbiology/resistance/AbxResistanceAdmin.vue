...
const tabs = computed(() => [
  {
    id: "abx-expert-interpretation-rule", label: "expert-interpretation-rule",
    component: defineAsyncComponent(() => import("./AbxExpertInterpretationRule.vue")),
  },
  {
...
<template>
  <FelTabs :tabs="tabs" initial-tab="antibiotics"/>
</template>
