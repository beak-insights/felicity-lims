      ...
      <template v-slot:body>
        <div class="overflow-x-auto my-4">
          <div v-if="reports?.length > 0"
            class="align-middle inline-block min-w-full shadow overflow-hidden bg-background shadow-dashboard px-2 pt-1 rounded-bl-sm rounded-br-sm">
            <table class="min-w-full">
              ...
              <tbody class="bg-background">
                <tr v-for="report in reports" :key="report.uid">
                  ...
                  <td class="px-1 py-1 whitespace-no-wrap border-b border-border">
                    <div class="text-sm leading-5 text-primary">{{ report?.status }}</div>
                  </td>
          ...
          <div v-else class="py-4 pl-4 bg-background">
          ...
          <form action="post" class="p-1">
            <div class="grid grid-cols-3 gap-x-4 mb-4">
              <label class="block col-span-1 mb-2">
                <span class="text-foreground">Report Type</span>
              ...
              <label class="block col-span-1 mb-2">
                <span class="text-foreground">States</span>
            ...
            <div class="grid grid-cols-3 gap-x-4 mb-4">
              <label class="block col-span-1 mb-2">
                <span class="text-foreground">Period Date Criteria</span>
              ...
              <label class="block col-span-1 mb-2">
                <span class="text-foreground">Period Start</span>
              ...
              <label class="block col-span-1 mb-2">
                <span class="text-foreground">Period End</span>
